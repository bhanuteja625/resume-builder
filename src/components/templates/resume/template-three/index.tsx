...
type ThirdTemplateProps = {
  ref: React.Ref<HTMLDivElement>
  data: FieldValues
}

export const TemplateThree: React.FC<ThirdTemplateProps> = forwardRef(
  (props, ref) => {
...
const Page = styled.div`
  ...
  font-family: 'Your-Preferred-Font'; /* Replace with the font you prefer */
`
